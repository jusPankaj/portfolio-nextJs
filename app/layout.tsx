  ...
  return (
    <html lang="en">
      <body className={`{inter.className} bg-gray-50 text-gray-950 h-[5000px]`}>
        ...
        <div className="bg-[#dbd7fb] absolute top-[-1rem] left-[-35rem] h-[31.25rem] -z-10 w-[50rem] rounded-full blur-[10rem] sm:w-[69.75rem] md:left-]-33rem] lg:left-[-28rem] xl:left-[-15rem] 2xl:left-[-5rem]"></div>
        <Header />
        {children}
      </body>
    </html>
